...
$lang = array_merge($lang, array(
	...
	'CLI_DESCRIPTION_USER_ACTIVATE_ACTIVE'		=> 'Корисникот е веќе активен.',
	'CLI_DESCRIPTION_USER_ACTIVATE_INACTIVE'	=> 'Корисник е веќе неактивен.',
	'CLI_DESCRIPTION_USER_ADD'					=> 'Додади нов корисник.',
	'CLI_DESCRIPTION_USER_ADD_OPTION_USERNAME'	=> 'Корисничко име на корисникот',
	'CLI_DESCRIPTION_USER_ADD_OPTION_PASSWORD'	=> 'Лозинка на новиот корисник',
	'CLI_DESCRIPTION_USER_ADD_OPTION_EMAIL'		=> 'E-mail адреса на новиот корисник',
	'CLI_DESCRIPTION_USER_ADD_OPTION_NOTIFY'	=> 'Send account activation email to the new user (not sent by default)',
	'CLI_DESCRIPTION_USER_DELETE'				=> 'Избриши профил на корисник.',
	'CLI_DESCRIPTION_USER_DELETE_USERNAME'		=> 'Корисничко име на корисникот кој ќе се брише',
	'CLI_DESCRIPTION_USER_DELETE_OPTION_POSTS'	=> 'Избриши ги сите објави од корисникот. Without this option, the user’s posts will be retained.',
	'CLI_DESCRIPTION_USER_RECLEAN'				=> 'Re-clean usernames.',

	'CLI_EXTENSION_DISABLE_FAILURE'		=> 'Could not disable extension %s',
	'CLI_EXTENSION_DISABLE_SUCCESS'		=> 'Successfully disabled extension %s',
	'CLI_EXTENSION_DISABLED'			=> 'Екстензијата %s не е овозможена',
	'CLI_EXTENSION_ENABLE_FAILURE'		=> 'Could not enable extension %s',
	'CLI_EXTENSION_ENABLE_SUCCESS'		=> 'Успешно овозможена екстензијата %s',
	'CLI_EXTENSION_ENABLED'				=> 'Екстензијата %s е веќе овозможена',
	'CLI_EXTENSION_NOT_EXIST'			=> 'Екстензијата %s не постои',
	'CLI_EXTENSION_NAME'				=> 'Име на екстензијата',
	...
	'CLI_EXTENSIONS_AVAILABLE'			=> 'Достапно',
	'CLI_EXTENSIONS_DISABLED'			=> 'Оневозможено',
	'CLI_EXTENSIONS_ENABLED'			=> 'Овозможено',
